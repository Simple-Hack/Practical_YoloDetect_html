...
plt.xlabel('x(海里)',fontproperties="SimHei")
plt.ylabel('y(海里)',fontproperties="SimHei")
for region in regions:
    ...
    if region['x_or_y']=='x':
        ...
        plt.vlines(res,region['y_min']/1852,region['y_max']/1852,colors='k',linestyles='solid',label='')
    else:
        ...
        plt.hlines(res,region['x_min']/1852,region['x_max']/1852,colors='k',linestyles='solid',label='')
